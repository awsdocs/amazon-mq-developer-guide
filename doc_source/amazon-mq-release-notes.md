...
| March 1, 2018 | You can configure the [concurrent store and dispatch](concurrent-store-and-dispatch-for-queues.md) for Apache KahaDB using the [`concurrentStoreAndDispatchQueues`](child-element-details.md#concurrentStoreAndDispatchQueues) attribute\. | 
