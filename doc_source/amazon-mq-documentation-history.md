...
| January 5, 2019 | Improved documentation on some per\-minute metrics\. For more information, see the following: [Destination \(Queue and Topic\) Metrics](amazon-mq-monitoring-cloudwatch.md#destination-queue-topic-metrics)\. | 
