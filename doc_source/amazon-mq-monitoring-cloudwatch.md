...
**Note**  
`TotalEnqueueCount` and `TotalDequeueCount` metrics include messages for advisory topics\. Please see the [ActiveMQ documentation](https://activemq.apache.org/advisory-message.html) for additional information regarding advisory messages\.
